...
class ContactFormController extends Controller
{
    ...
    {
        // $contacts = ContactForm::select('id','name','tittle','created_at')->get();

         //ページネーション
         //$contacts = ContactForm::select('id','name','tittle','created_at')
         //->paginate(20);
        ...
        $contacts = $query->select('id','name','tittle','created_at')
        ->paginate(20);
