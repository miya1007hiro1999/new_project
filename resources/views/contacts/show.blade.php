                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <div 
                                                class="w-full  rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$contact->tittle}}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            @if($contact->url)
                                            <div 
                                                class="w-full  rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$contact->url}}</div>
                                            @endif
                                            </div>
                                    </div>
                                    ...
                                    <form action="get" action ='{{route('contacts.edit',['id'=>$contact->id ])}}'>
                                        <div class="p-2 w-full">
                                            <button
                                    ...
                                    <form id="delete_{{$contact->id}}"" action="post" action ='{{ route('contacts.destroy',['id'=>$contact->id ])}}'>
                                        @csrf
                                        <div class="p-2 w-full">
